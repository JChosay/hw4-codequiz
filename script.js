...
function landingScreen(){
    var timerDisplay = document.getElementById("timer").style.display = "none";
    var scoreCount = document.getElementById("score").style.display = "none";
    var landingPage = document.getElementById("contentarea");
    var landingh1Tag = document.createElement("h1");
    var landingh1text = document.createTextNode("go fuck yourself")
    landingh1Tag.appendChild(landingh1text);  
    landingPage.appendChild(landingh1Tag);

    var landingh2Tag = document.createElement("h2");
    var landingh2text = document.createTextNode("go fuck yourself AGAIN!")
...
function startQuiz(){
    ...
    var timerLabel = document.getElementById("timer").style.removeProperty('display');
    var scoreCount = document.getElementById("score").style.removeProperty('display');
...
function wrongAnswer(){
    console.log("Wrong, you bone-dumb motherfucker.");
    score--;
    pageQuizContent();
}

function rightAnswer(){
    console.log("Correct. Well, look at YOU.");
    score++;
    numLeft--;
    console.log("There are "+numLeft+" items left in the question array.");
    pageQuizContent();
}